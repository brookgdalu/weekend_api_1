var apikey = '122a115ba5004568972a60ac13caeb58'; // Put your API key here
...
// Example 1 - Cross Site Error
	$.ajax ({
	    ...
	    dataType: 'json',
	    crossDomain: true,
	    url: 'http://realtime.influenceexplorer.com/api//candidates/?format=json&page=1&page_size=100&state=MN&office=S&apikey=' + apikey,
	    complete: function() {
